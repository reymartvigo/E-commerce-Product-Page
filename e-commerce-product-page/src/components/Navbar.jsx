...
const Navbar = () => {
    ...
    return (
        <div className="header flex justify-between items-center py-5 px-5">
            ...
            <div className="cart-wrapper flex items-center gap-5 ">
                <button className="outline-none cursor-pointer"><img src={Cart} alt="cart" aria-hidden="true"></img></button>
